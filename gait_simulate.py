...
class GaitSimulator:
    ...
    def dynamics(self, x, t):
        ...
        xd = [0, 0, 0, 0]
        xd[0] = d_beta
        xd[1] = (torque_soleus - torque_tibant + r.knee_torque(t) - r.hip_torque(t) + gravity_moment_ankle(beta, theta, H)) / I_ANKLE 
        xd[2] = vm_soleus
        xd[3] = vm_tibialis
        return xd
    ...
    def simulate(self):
        ...
        x0 = [beta0, 0, 1.1, 0.95] # TODO: initial values need to be determined 
        sol = solve_ivp(
                        f, 
                        [t0, CYCLE_PERIOD], 
                        x0, 
