...
def get_soleus_activation_regression():
    ...
    #Normalize y to be from 0.005 to 1 to estimate muscle activation from EMG
    norm_y = [(j-min_val+0.005)/(max_val-min_val) for j in y]
...
def get_hip_angle_regression():
    data = np.array([
        ...
        [51.4792899408284, -12.791208791208817],
        [54.31952662721893, -10.032967032967008],
        [56.804733727810664, -8.835164835164818],
        [58.934911242603555, -6.318681318681314],
        [60.71005917159763, -4.758241758241752],
        [62.13017751479291, -2.39560439560438],
        [63.905325443786985, 0.35164835164835],
        [66.03550295857988, 8.747252747252759],
